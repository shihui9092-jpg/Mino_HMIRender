...
Shader "S_Laucher_CarGlass"
{
	Properties
	{
		...
		_Speed("流速", Float) = 0.1
		[Header((FlowTex))][Space(5)]_FlowTex("FlowTex", 2D) = "white" {}
		[Toggle]_FlowControl("Flow开关", Range( 0 , 1)) = 0
		_FlowSpeed("FlowSpeed", Float) = 0
		_FlowColor("FlowColor", Color) = (0,0,0,0)
		[Header((WindowMaskTex))][Space(5)]_WindowMask("WindowMask", 2D) = "white" {}
		[Toggle]_WindowMaskControl("WindowMaskControl", Range( 0 , 1)) = 0
		_WindowMaskColor("Window'MaskColor", Color) = (0,0,0,0)
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 _CubeColor;
			float4 _FlowColor;
			float4 _WindowMask_ST;
			float4 _WindowMaskColor;
			float _Speed;
			float _RainControl;
			float _RainAlpha;
			float _FlowSpeed;
				 ...
				 ) : SV_Target
			{
				...
				float3 temp_output_102_0 = ( WorldPosition * float3(0.5,1,0.5) );
				half3 Position160_g45 = temp_output_102_0;
				float3 break170_g45 = Position160_g45;
				float2 appendResult171_g45 = (float2(break170_g45.z , break170_g45.y));
				float3 ase_worldNormal = IN.ase_texcoord4.xyz;
				half3 Normal168_g45 = ase_worldNormal;
				float2 temp_output_180_0_g45 = abs( (Normal168_g45).xz );
				float2 temp_output_205_0_g45 = ( temp_output_180_0_g45 * temp_output_180_0_g45 * temp_output_180_0_g45 * temp_output_180_0_g45 * temp_output_180_0_g45 * temp_output_180_0_g45 * temp_output_180_0_g45 * temp_output_180_0_g45 );
				float2 break183_g45 = temp_output_205_0_g45;
				float2 break185_g45 = ( temp_output_205_0_g45 / max( ( break183_g45.x + break183_g45.y ) , 1E-05 ) );
				float3 break186_g45 = Position160_g45;
				float2 appendResult191_g45 = (float2(break186_g45.x , break186_g45.y));
				half3 Position160_g44 = ( ( _TimeParameters.x * float3(0,1,0) * _Speed ) + temp_output_102_0 );
				float3 break170_g44 = Position160_g44;
				float2 appendResult171_g44 = (float2(break170_g44.z , break170_g44.y));
				half3 Normal168_g44 = ase_worldNormal;
				float2 temp_output_180_0_g44 = abs( (Normal168_g44).xz );
				float2 temp_output_205_0_g44 = ( temp_output_180_0_g44 * temp_output_180_0_g44 * temp_output_180_0_g44 * temp_output_180_0_g44 * temp_output_180_0_g44 * temp_output_180_0_g44 * temp_output_180_0_g44 * temp_output_180_0_g44 );
				float2 break183_g44 = temp_output_205_0_g44;
				float2 break185_g44 = ( temp_output_205_0_g44 / max( ( break183_g44.x + break183_g44.y ) , 1E-05 ) );
				float3 break186_g44 = Position160_g44;
				float2 appendResult191_g44 = (float2(break186_g44.x , break186_g44.y));
				float clampResult110 = clamp( ( ( ( tex2D( _RainMask, appendResult171_g44 ) * break185_g44.x ) + ( tex2D( _RainMask, appendResult191_g44 ) * break185_g44.y ) ).g * ( ( tex2D( _RainMask, appendResult171_g44 ) * break185_g44.x ) + ( tex2D( _RainMask, appendResult191_g44 ) * break185_g44.y ) ).g * ( ( tex2D( _RainMask, appendResult171_g44 ) * break185_g44.x ) + ( tex2D( _RainMask, appendResult191_g44 ) * break185_g44.y ) ).g * ( ( tex2D( _RainMask, appendResult171_g44 ) * break185_g44.x ) + ( tex2D( _RainMask, appendResult191_g44 ) * break185_g44.y ) ).g * ( ( tex2D( _RainMask, appendResult171_g44 ) * break185_g44.x ) + ( tex2D( _RainMask, appendResult191_g44 ) * break185_g44.y ) ).g * ( ( tex2D( _RainMask, appendResult171_g44 ) * break185_g44.x ) + ( tex2D( _RainMask, appendResult191_g44 ) * break185_g44.y ) ).g * ( ( tex2D( _RainMask, appendResult171_g44 ) * break185_g44.x ) + ( tex2D( _RainMask, appendResult191_g44 ) * break185_g44.y ) ).g * ( ( tex2D( _RainMask, appendResult171_g44 ) * break185_g44.x ) + ( tex2D( _RainMask, appendResult191_g44 ) * break185_g44.y ) ).g ) , 0.0 , 1.0 );
				float clampResult119 = clamp( ( ( ( ( tex2D( _RainMask, appendResult171_g45 ) * break185_g45.x ) + ( tex2D( _RainMask, appendResult191_g45 ) * break185_g45.y ) ).r - clampResult110 ) * 5.0 ) , 0.0 , 1.0 );
				float3 Rain124 = ( clampResult119 * _RainControl * _RainAlpha * _Color0.rgb );
				...
				float2 panner131 = ( 1.0 * _Time.y * temp_cast_2 + texCoord129);
				float4 Flow135 = ( tex2D( _FlowTex, panner131 ) * _FlowColor * _FlowControl );
				float2 uv3_WindowMask = IN.ase_texcoord5.zw * _WindowMask_ST.xy + _WindowMask_ST.zw;
				float4 WindowMask161 = ( float4( tex2D( _WindowMask, uv3_WindowMask ).rgb , 0.0 ) * _WindowMaskControl * _WindowMaskColor );
				
				float Alpha89 = ( _CubeColor.a * _Alpha );
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = ( float4( Rain124 , 0.0 ) + RGB90 + Flow135 + WindowMask161 ).rgb;
				float Alpha = Alpha89;
...
Node;AmplifyShaderEditor.RangedFloatNode;98;-4881.125,942.9814;Inherit;False;Property;_Speed;流速;8;0;Create;False;0;0;0;False;0;False;0.1;0.3;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;120;-2705.125,366.9814;Inherit;False;Property;_RainAlpha;雨透明度;7;0;Create;False;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;121;-2705.125,494.9814;Inherit;False;Property;_Color0;雨水颜色;6;0;Create;False;0;0;0;False;0;False;1,1,1,1;0.1490192,0.1490192,0.1490192,0.3568628;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.ColorNode;133;-3840,-640;Inherit;False;Property;_FlowColor;FlowColor;12;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0.2791152,0.3113208,1;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.Vector3Node;84;-4928,-1856;Inherit;False;Constant;_MApDirection;MApDirection;3;0;Create;True;0;0;0;False;0;False;1,1,1;1,1,1;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.SamplerNode;132;-3840,-896;Inherit;True;Property;_FlowTex;FlowTex;9;1;[Header];Create;True;1;(FlowTex);0;0;False;1;Space(5);False;-1;None;cd2d8a8be848acd4a833b18ddc8a50ac;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.RangedFloatNode;130;-4608,-640;Inherit;False;Property;_FlowSpeed;FlowSpeed;11;0;Create;True;0;0;0;False;0;False;0;0.5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;126;-1776,-2208;Inherit;False;124;Rain;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SimpleAddOpNode;125;-1392,-2208;Inherit;False;4;4;0;FLOAT3;0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;136;-1776,-1952;Inherit;False;135;Flow;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;138;-3840,-416;Inherit;False;Property;_FlowControl;Flow开关;10;1;[Toggle];Create;False;0;0;0;True;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;157;-928,-528;Inherit;True;Property;_WindowMask;WindowMask;13;1;[Header];Create;True;1;(WindowMaskTex);0;0;False;1;Space(5);False;-1;None;581e0ebd8f788704f9321370a6b17fd7;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.GetLocalVarNode;167;-1808,-1792;Inherit;False;161;WindowMask;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;163;-928,-256;Inherit;False;Property;_WindowMaskControl;WindowMaskControl;14;1;[Toggle];Create;True;0;0;0;True;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;168;-784,-128;Inherit;False;Property;_WindowMaskColor;Window'MaskColor;15;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.1933962,0.4969533,1,1;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
WireConnection;125;3;167;0
WireConnection;157;1;158;0
WireConnection;65;2;125;0
WireConnection;65;3;92;0
ASEEND*/
//CHKSM=7C13FEE12B035903C5EE1C6FD7E0F6D2BCE7B1BC