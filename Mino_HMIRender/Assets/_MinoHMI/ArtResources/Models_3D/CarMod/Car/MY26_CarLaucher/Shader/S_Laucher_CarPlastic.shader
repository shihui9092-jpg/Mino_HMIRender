	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float3 BaseColor = tex2D( _MainTex, uv_MainTex10 ).rgb;
...
Node;AmplifyShaderEditor.RangedFloatNode;18;-384,256;Inherit;False;Property;_SmoothScale;SmoothScale;3;0;Create;True;0;0;0;False;0;False;0;0.77;0;1;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=BF5913B58990E2F11479D61C16E191C76686DA36