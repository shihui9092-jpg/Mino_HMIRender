...
Shader "S_UniltSky"
{
	Properties
	{
		...
		[HDR][Header((Sun))]_SunColor("太阳颜色", Color) = (1,1,1,0)
		_SunIntensity("太阳亮度", Float) = 1
		_SunRadius("太阳大小", Range( -0.5 , 1)) = 0.002
	...
	LOD 100
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				float3 temp_output_473_0 = ( ( ( SunTintColor460 * _SunIntensity ) * ( _SunBloom * 0.01 ) ) / sqrt( max( ( (-SunDotV193*0.5 + 0.5) - ( _SunRadius * 0.004 ) ) , 0.0002 ) ) );
				...
				float clampResult607 = clamp( saturate( abs( pow( ( 1.0 - temp_output_108_0 ) , _HorizonLineExponent ) ) ) , 0.0 , 1.0 );
				float4 lerpResult70 = lerp( temp_cast_1 , ( _HorizonLineColor * clampResult607 ) , _HorizonLineContribution);
				...
				float4 temp_output_554_0 = ( FinalColor92 + float4( 0,0,0,0 ) );
				
				
				finalColor = ( float4( SunColor475 , 0.0 ) + float4( 0,0,0,0 ) + temp_output_554_0 );
				return finalColor;
			}
			ENDCG
		}
...
Node;AmplifyShaderEditor.CommentaryNode;317;-3184,-2192;Inherit;False;3236;992;horizonLineColor;22;64;66;108;67;69;68;179;73;62;63;71;72;70;74;369;371;372;374;370;383;384;607;horizonLineColor;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.Vector3Node;219;-7760,-4240;Inherit;False;Property;_SunRotation;太阳角度;10;0;Create;False;0;0;0;False;0;False;0,0,0;-365.8,-105.1,314.6;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.AbsOpNode;108;-2848,-1632;Inherit;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;69;-2464,-1536;Inherit;True;Property;_HorizonLineExponent;边际线混合强度;5;0;Create;False;0;0;0;False;0;False;6.8;8;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;62;-1600,-1968;Inherit;False;Property;_HorizonLineColor;边际线颜色_昼;3;1;[Header];Create;False;1;(HorizonLine);0;0;False;0;False;1,1,1,1;1,1,1,1;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.ClampOpNode;607;-1216,-1760;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.NegateNode;459;-7632,-2192;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;458;-7744,-2048;Inherit;False;Property;_SunRadius;太阳大小;8;0;Create;False;0;0;0;False;0;False;0.002;0.005;-0.5;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;461;-7680,-1920;Inherit;False;Constant;_Float10;Float 10;23;0;Create;True;0;0;0;False;0;False;0.004;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;455;-7824,-2528;Inherit;False;Property;_SunColor;太阳颜色;6;2;[HDR];[Header];Create;False;1;(Sun);0;0;False;0;False;1,1,1,0;0.6981132,0.6981132,0.6981132,1;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.RangedFloatNode;83;1024,-1984;Inherit;True;Property;_SkyGradientExponent;高低空混合值;2;0;Create;False;0;0;0;False;0;False;1;5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;72;-976,-1584;Inherit;True;Property;_HorizonLineContribution;边际线大小;4;0;Create;False;0;0;0;False;0;False;1;0.85;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;63;-1040,-1968;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;462;-7408,-2048;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;467;-6992,-2368;Inherit;False;Property;_SunBloom;太阳光晕;9;0;Create;False;0;0;0;False;0;False;0.04;5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;76;1456,-2464;Inherit;False;Property;_SkyGradientBottom;低空颜色_昼;1;0;Create;False;0;0;0;False;0;False;1,1,1,1;0.1981132,0.1981132,0.1981132,1;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.ColorNode;75;1456,-2672;Inherit;False;Property;_SkyGradientTop;高空颜色_昼;0;1;[Header];Create;False;1;(Sky);0;0;False;0;False;1,1,1,1;0.3443396,0.5486548,1,1;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;474;-6160,-2528;Inherit;True;2;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.GetLocalVarNode;93;-3072,640;Inherit;False;92;FinalColor;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;475;-5936,-2528;Inherit;True;SunColor;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.CommentaryNode;259;-3136,-4736;Inherit;False;2011.602;969.2559;Static BackGround;11;276;264;271;360;365;272;262;261;260;299;298;Static BackGround;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;554;-2736,640;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.Vector2Node;260;-2816,-4480;Inherit;False;Property;_StarTilling;星星平铺值;23;0;Create;False;0;0;0;False;0;False;1,1;15,5;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;453;80,-5024;Inherit;False;Property;_Float16;闪烁速度;21;0;Create;False;0;0;0;False;0;False;0;0.25;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;281;1168,-5744;Inherit;False;Property;_StarColor;星星颜色;20;0;Create;False;0;0;0;False;0;False;0,0,0,0;1,1,1,1;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.RangedFloatNode;285;1296,-5264;Inherit;False;Property;_StarsIntensityHigh;星星亮度;22;0;Create;False;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;320;-3104,-368;Inherit;False;Property;_RotationSpeed;旋转速度;28;0;Create;False;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;321;-2928,-672;Inherit;False;Property;_Rotation;旋转角度;26;0;Create;False;0;0;0;False;0;False;0;160;0;360;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;368;-2832,992;Inherit;False;Property;_Float9;亮度;27;0;Create;False;0;0;0;False;0;False;3;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;385;-2896,1072;Inherit;False;Property;_Color0;颜色;29;0;Create;False;0;0;0;False;0;False;0,0,0,0;0,0.7098041,1,1;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.RangedFloatNode;286;-2992,-2608;Inherit;False;Property;_CloudsBackgroundBrightness;云层透明度;19;0;Create;False;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;290;-2688,-2880;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;381;-2672,-2608;Inherit;False;17;MaskHorizon;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;380;-2448,-2880;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;288;-2928,-3248;Inherit;False;Property;_CloudsBackgroundColor;云层颜色;18;0;Create;False;0;0;0;False;0;False;0,0,0,0;0.8349056,0.9135507,1,1;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.Vector3Node;533;-7744,-3712;Half;False;Property;_MoonDirection;月亮角度;16;0;Create;False;1;Moon Color;0;0;False;0;False;0,0,0;-60,-35,-35;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.RangedFloatNode;485;-7088,-1008;Half;False;Property;_MoonSize;月亮大小;14;0;Create;False;0;0;0;False;0;False;0.4060405;0.35;-0.5;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;494;-5792,-1344;Inherit;True;Property;_MoonTex;月亮贴图;11;1;[Header];Create;False;1;(Moon);0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.ColorNode;560;-5312,-400;Inherit;False;Property;_MoonColor;月亮颜色;12;0;Create;False;0;0;0;False;0;False;0,0,0,0;1,1,1,1;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.RangedFloatNode;573;-6896,-320;Inherit;False;Property;_MoonBloom;月亮光晕;15;0;Create;False;0;0;0;False;0;False;0.04;0.05;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;563;-4784,-320;Inherit;False;Property;_MoonIntensity;月亮亮度;13;0;Create;False;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;217;-2000,448;Inherit;True;3;3;0;FLOAT3;0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;532;-2400,544;Inherit;False;569;MoonColor;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.LerpOp;302;-2416,672;Inherit;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;222;-1696,448;Float;False;True;-1;2;ASEMaterialInspector;100;5;S_UniltSky;0770190933193b94aaa3065e307002fa;True;Unlit;0;0;Unlit;2;False;True;0;1;False;;0;False;;0;1;False;;0;False;;True;0;False;;0;False;;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;RenderType=Background=RenderType;True;5;False;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;0;;0;0;Standard;1;Vertex Position,InvertActionOnDeselection;1;0;0;1;True;False;;False;0
...
WireConnection;607;0;73;0
WireConnection;459;0;457;0
WireConnection;81;0;78;0
WireConnection;81;1;80;0
WireConnection;63;0;62;0
WireConnection;63;1;607;0
